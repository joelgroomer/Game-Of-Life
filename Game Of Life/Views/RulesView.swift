...
"Neighbors" here means any of the 8 adjacent cells. On the "Options" tab, you have the ability to apply variations to the rules to see how they effect the game of life.
"""
                )
            }.padding()
        }
